          ...
          <div className="text-center">
            <div className="bg-white rounded-lg shadow-lg p-8 max-w-2xl mx-auto">
              ...
              <p className="text-gray-600 mb-4">
                We're updating our market insights. Check back soon for the latest real estate
                trends and analysis from Dr. Janet Duffy.
              </p>
              <div className="text-sm text-gray-500">
                <p>In the meantime, contact us for personalized market analysis:</p>
                <a
                  href="tel:(702) 500-1981"
                  className="font-semibold text-blue-600 mt-2 hover:text-blue-800 transition-colors"
                >
                  (702) 500-1981
                </a>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <header className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Stay informed with expert real estate insights, market trends, and analysis from Dr.
            Janet Duffy. Get the latest updates on Las Vegas and Southern California real estate
            markets.
          </p>
        </header>
