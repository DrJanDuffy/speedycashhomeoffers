      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Sell house fast San Diego! Dr. Janet Duffy pays cash for homes in San Diego, Chula Vista, Oceanside. No fees, no repairs, fast closing. Get offer today!",
            "url": "https://www.speedycashhomeoffers.com/sell-my-house-fast-san-diego",
