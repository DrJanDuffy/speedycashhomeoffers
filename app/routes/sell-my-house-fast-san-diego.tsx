...
export const meta: Route.MetaFunction = () => {
  return [
    { title: "Sell My House Fast San Diego | Speedy Cash Home Offers" },
    {
      name: "description",
      content:
        "Sell house fast San Diego! Dr. Janet Duffy pays cash for homes in San Diego, Chula Vista, Oceanside. No fees, no repairs, fast closing. Get offer today!",
    },
    {
      name: "keywords",
      content:
        "sell house fast San Diego, cash home buyers San Diego, Dr. Janet Duffy San Diego, sell house as is San Diego, cash offer San Diego California, we buy houses San Diego",
    },
    ...
    { name: "robots", content: "index, follow" },
    {
      tagName: "link",
      rel: "canonical",
      href: "https://www.speedycashhomeoffers.com/sell-my-house-fast-san-diego",
    },
    // Open Graph / Facebook
    { property: "og:type", content: "website" },
    {
      property: "og:url",
      content: "https://www.speedycashhomeoffers.com/sell-my-house-fast-san-diego",
    },
    { property: "og:title", content: "Sell My House Fast San Diego | Speedy Cash Home Offers" },
    {
      property: "og:description",
      content:
        "Dr. Janet Duffy has purchased thousands of homes in San Diego California and we pay cash fast. Find out how much money you can get today!",
    },
    {
      property: "og:image",
      content: "https://www.speedycashhomeoffers.com/images/san-diego-og.jpg",
    }, // Placeholder image
    // Twitter
    ...
    },
    {
      ...
      content: "Sell My House Fast San Diego | Speedy Cash Home Offers",
    },
    {
    ...
    },
    {
      ...
      content: "https://www.speedycashhomeoffers.com/images/san-diego-twitter.jpg",
    }, // Placeholder image
  ];
};
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "WebPage",
            name: "Sell My House Fast San Diego | Speedy Cash Home Offers",
            description:
              "Sell house fast San Diego! Dr. Janet Duffy pays cash for homes in San Diego, Chula Vista, Oceanside. No fees, no repairs, fast closing. Get offer today!",
            url: "https://www.speedycashhomeoffers.com/sell-my-house-fast-san-diego",
      ...
      <section className="bg-gradient-to-r from-green-600 to-green-800 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">Sell My House Fast San Diego</h1>
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
              Dr. Janet Duffy has purchased thousands of homes in San Diego California and we pay
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <ul className="space-y-3 text-gray-600">
                ...
                <li>
                  • The current median house price in San Diego County is approximately $850,000.
                </li>
                <li>
                  • Major cities include San Diego, Chula Vista, Oceanside, Escondido, and Carlsbad.
                </li>
                <li>
                  • San Diego is home to major military installations including Naval Base San
                  Diego.
                </li>
                ...
                <li>
                  • Major employers include Qualcomm, Illumina, and various biotech companies.
                </li>
                <li>
                  • San Diego has a diverse economy including tourism, military, and technology.
                </li>
              </ul>
            </div>
            <div className="bg-white rounded-lg shadow-lg p-6">
              <h3 className="text-xl font-semibold mb-4 text-green-600">
                Why San Diego is Great for Real Estate
              </h3>
              <ul className="space-y-3 text-gray-600">
                <li>
                  • <strong>Perfect Weather:</strong> Year-round mild climate with 70+ miles of
                  coastline.
                </li>
                <li>
                  • <strong>Biotech Hub:</strong> Major biotechnology and life sciences industry.
                </li>
                <li>
                  • <strong>Military Presence:</strong> Strong military economy with multiple bases.
                </li>
                <li>
                  • <strong>Tourism:</strong> World-class attractions including San Diego Zoo and
                  SeaWorld.
                </li>
                <li>
                  • <strong>Outdoor Recreation:</strong> Beaches, mountains, deserts, and parks.
                </li>
                <li>
                  • <strong>Excellent Schools:</strong> Top-rated public and private schools.
                </li>
                <li>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-gray-600 text-center mb-12 max-w-4xl mx-auto">
            We buy houses in San Diego in Any Condition As-Is and fast for cash! Some of the ways we
            help you are:
          </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <p className="text-gray-600">
                We leverage our local San Diego real estate expertise that understands the market.
              </p>
            </div>
            <div className="bg-white rounded-lg shadow-lg p-6">
              <div className="bg-green-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gray-50 rounded-lg p-6">
              ...
              <p className="text-gray-600">
                ...
                home in La Jolla so easy and stress-free."
              </p>
            </div>
            <div className="bg-gray-50 rounded-lg p-6">
              <div className="flex items-center mb-4">
      ...
      <section className="py-16 bg-green-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-6">Ready to Sell Your San Diego Home Fast?</h2>
          <p className="text-xl mb-8">
            Dr. Janet Duffy has purchased thousands of homes in San Diego California and we pay cash
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-bold text-center mb-6 text-gray-900">
            Find Your Perfect Property in San Diego
          </h1>
