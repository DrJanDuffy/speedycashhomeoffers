...
export const meta: Route.MetaFunction = () => {
  return [
    { title: "Real Estate Market Insights | Speedy Cash Home Offers" },
    {
      name: "description",
      content:
        "Expert real estate market insights, analysis, and professional guidance for Las Vegas and Southern California markets from Dr. Janet Duffy. Stay informed with current market data and trends.",
    },
    {
      name: "keywords",
      content:
        "real estate market insights, Las Vegas real estate market, Southern California real estate, market analysis, Dr Janet Duffy insights, real estate trends",
    },
    ...
    { name: "robots", content: "index, follow" },
    {
      tagName: "link",
      rel: "canonical",
      href: "https://www.speedycashhomeoffers.com/market-insights",
    },
    { property: "og:title", content: "Real Estate Market Insights | Speedy Cash Home Offers" },
    {
      property: "og:description",
      content:
        "Expert insights, market analysis, and professional guidance for Las Vegas and California real estate markets from Dr. Janet Duffy.",
    },
    { property: "og:type", content: "website" },
    { property: "og:url", content: "https://www.speedycashhomeoffers.com/market-insights" },
    {
      property: "og:image",
      content: "https://www.speedycashhomeoffers.com/images/market-insights-og-image.jpg",
    },
    ...
    {
      name: "twitter:image",
      content: "https://www.speedycashhomeoffers.com/images/market-insights-twitter-image.jpg",
    },
  ];
};
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Expert real estate market insights and analysis for Las Vegas and Southern California markets",
            url: "https://www.speedycashhomeoffers.com/market-insights",
            mainEntity: {
              "@type": "Dataset",
              name: "Real Estate Market Data",
              description:
                "Current market data for Las Vegas and Southern California real estate markets",
              creator: {
                "@type": "Person",
                name: "Dr. Janet Duffy",
      ...
      <section className="bg-gradient-to-r from-cyan-600 to-cyan-800 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">Your Real Estate Advantage</h1>
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
              Expert insights, market analysis, and professional guidance for Las Vegas and
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-4xl mx-auto">
              Stay ahead of the market with Dr. Janet Duffy's expert analysis of Las Vegas and
              Southern California real estate trends. Our comprehensive market insights provide you
              with the data and analysis needed to make informed decisions about your property.
              Whether you're considering selling your home, investing in real estate, or simply want
              to understand current market conditions, our detailed market reports offer valuable
              insights into inventory levels, demand patterns, pricing trends, and expected market
              times across multiple metropolitan areas.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-center text-gray-600 mb-8">
            Real-time insights into the Las Vegas Real Estate market, providing comprehensive data
            on inventory, demand, and market trends.
          </p>
          <p className="text-center text-sm text-gray-500 mb-12">Last updated: 9/12/2025</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-center text-gray-600 mb-12 max-w-4xl mx-auto">
            Our comprehensive analysis of Southern California real estate markets provides detailed
            insights into inventory trends, demand patterns, and market timing across Los Angeles,
            Orange County, Riverside, and San Bernardino counties. These insights help homeowners
            understand current market conditions and make informed decisions about selling their
            properties.
          </p>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
            <h3 className="text-2xl font-bold mb-6 text-gray-900">
              Current Los Angeles County Market Data
            </h3>
            <p className="text-gray-600 mb-4">
              Real-time insights into the Los Angeles County Real Estate market, including detailed
              analysis of inventory and demand trends.
            </p>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
            <h3 className="text-2xl font-bold mb-6 text-gray-900">
              Current Orange County Market Data
            </h3>
            <p className="text-gray-600 mb-4">
              Real-time insights into the Orange County Real Estate market, featuring analysis of
              coastal and inland market trends.
            </p>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
            <h3 className="text-2xl font-bold mb-6 text-gray-900">
              Current Riverside County Market Data
            </h3>
            <p className="text-gray-600 mb-4">
              Real-time insights into the Riverside County Real Estate market, covering both urban
              and suburban areas.
            </p>
            <p className="text-sm text-gray-500 mb-6">Last updated: 8/12/2025</p>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            <h3 className="text-2xl font-bold mb-6 text-gray-900">
              Current San Bernardino County Market Data
            </h3>
            <p className="text-gray-600 mb-4">
              Real-time insights into the San Bernardino County Real Estate market, including
              analysis of desert and mountain communities.
            </p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-center text-gray-600 mb-12 max-w-4xl mx-auto">
            Stay up to date with Dr. Janet Duffy's latest television appearances and featured expert
            market analysis. Our media segments provide valuable insights into current real estate
            trends, market conditions, and practical advice for homeowners looking to sell their
            properties in Las Vegas and Southern California.
          </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gray-50 rounded-lg p-6">
              ...
              <p className="text-gray-600 text-sm">
                Dr. Janet Duffy discusses how to sell your home without the traditional stress and
                complications, providing practical strategies for homeowners in Los Angeles and
                surrounding areas.
              </p>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              ...
              <p className="text-gray-600 text-sm">
                Expert insights on navigating the current real estate market and making informed
                decisions about selling your property in today's competitive environment.
              </p>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              ...
              <p className="text-gray-600 text-sm">
                Analysis of current housing inventory trends and what it means for buyers and
                sellers in the Los Angeles metropolitan area.
              </p>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              ...
              <p className="text-sm text-gray-500 mb-4">July 1, 2025</p>
              <p className="text-gray-600 text-sm">
                Discussion on housing affordability challenges and solutions for California
                residents, including alternative selling strategies for homeowners.
              </p>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-center text-gray-600 mb-12 max-w-4xl mx-auto">
            Stay up to date with our latest radio segments featuring real estate insights and
            current market information. Dr. Janet Duffy regularly appears on various radio programs
            to discuss market trends, selling strategies, and provide expert commentary on real
            estate conditions affecting homeowners across Las Vegas and Southern California.
          </p>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-lg p-6">
              ...
              <p className="text-gray-600 mb-4">
                Dr. Janet Duffy discusses how climate change can affect the real estate market,
                including impacts on property values and selling strategies in affected areas.
              </p>
            ...
            <div className="bg-white rounded-lg p-6">
              <h3 className="text-lg font-semibold mb-2">
                ESPN: Sell your house quickly to Speedy Cash Home Offers
              </h3>
              <p className="text-gray-600 mb-4">
                Listen to Dr. Janet Duffy explain how to sell your house fast to us, including the
                benefits of working with cash home buyers versus traditional real estate agents.
              </p>
              <div className="flex items-center justify-between">
            ...
            <div className="bg-white rounded-lg p-6">
              <h3 className="text-lg font-semibold mb-2">
                ESPN: Easy vs complicated ways to sell your house
              </h3>
              <p className="text-gray-600 mb-4">
                Dr. Duffy talks about how Speedy Cash Home Offers makes the entire process easy and
                simple, contrasting our approach with traditional selling methods.
              </p>
              <div className="flex items-center justify-between">
                <p className="text-sm text-gray-500">June 20, 2025</p>
                <button className="bg-cyan-600 text-white px-4 py-2 rounded-lg text-sm font-semibold hover:bg-cyan-700 transition-colors">
            ...
            <div className="bg-white rounded-lg p-6">
              ...
              <p className="text-gray-600 mb-4">
                Dr. Duffy talks why Speedy Cash Home Offers offers the $20,000 advance to help
                homeowners move, explaining how this unique benefit helps families transition
                smoothly.
              </p>
              <div className="flex items-center justify-between">
                <p className="text-sm text-gray-500">June 20, 2025</p>
      ...
      <section className="py-16 bg-cyan-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8">
            ...
            days. Get expert market insights and a fair cash offer today! Our comprehensive market
            analysis helps us provide competitive offers that reflect current market conditions in
