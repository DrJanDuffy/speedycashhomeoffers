...
export const meta: Route.MetaFunction = () => {
  return [
    { title: "Real Estate Blog | Speedy Cash Home Offers" },
    {
      name: "description",
      content:
        "Read our real estate blog for home selling tips and market insights. Learn how to sell your house fast for cash in Las Vegas and Southern California with Dr. Janet Duffy's expert advice.",
    },
    {
      name: "keywords",
      content:
        "real estate blog, home selling tips, sell house fast Las Vegas, cash home buyers blog, Dr Janet Duffy blog, real estate advice",
    },
    ...
    { property: "og:title", content: "Real Estate Blog | Speedy Cash Home Offers" },
    {
      ...
      content:
        "Read our blog for home selling tips and real estate insights. Learn how to sell your house fast for cash with Dr. Janet Duffy's expert advice.",
    },
    { property: "og:type", content: "website" },
    { property: "og:url", content: "https://www.speedycashhomeoffers.com/blog" },
    {
      property: "og:image",
      content: "https://www.speedycashhomeoffers.com/images/blog-og-image.jpg",
    },
    ...
    {
      name: "twitter:image",
      content: "https://www.speedycashhomeoffers.com/images/blog-twitter-image.jpg",
    },
  ];
};
...
export default function Blog() {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Real estate blog featuring home selling tips and market insights from Dr. Janet Duffy",
            ...
            blogPost: [
              {
                ...
                description:
                  "Learn how Dr. Janet Duffy helps homeowners sell properties that traditional real estate agents won't touch.",
              ...
              },
              {
                ...
                description:
                  "Discover the hidden costs of selling a house traditionally versus selling to a cash buyer.",
      ...
      <section className="bg-gradient-to-r from-pink-600 to-pink-800 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">Real Estate Blog</h1>
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
              Dr. Janet Duffy has purchased thousands of houses and we can buy yours in just a few
              days. We buy houses for cash and there is no obligation, so contact us today or read
              our online reviews!
            </p>
      ...
      <MarketInsightsSection maxArticles={6} title="Latest Market Updates" className="bg-gray-50" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-4xl mx-auto">
              Welcome to the Speedy Cash Home Offers blog, your trusted source for real estate
              insights, home selling strategies, and market analysis. Led by Dr. Janet Duffy with
              over 25 years of experience in Las Vegas and Southern California real estate markets,
              our blog provides valuable information to help homeowners make informed decisions
              about selling their properties. Whether you're facing foreclosure, dealing with an
              inherited property, going through a divorce, or simply want to avoid the traditional
              selling process, our expert advice can guide you toward the best solution for your
              unique situation.
            </p>
          </div>
        </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-12">
            ...
            <span className="bg-gray-100 text-gray-800 px-4 py-2 rounded-full text-sm font-medium">
              Hoarder Home Selling
            </span>
            <span className="bg-gray-100 text-gray-800 px-4 py-2 rounded-full text-sm font-medium">
              Home Repairs
            </span>
            <span className="bg-gray-100 text-gray-800 px-4 py-2 rounded-full text-sm font-medium">
              Home Sales Gone Wrong
            </span>
            <span className="bg-gray-100 text-gray-800 px-4 py-2 rounded-full text-sm font-medium">
              Landlord Topics
            </span>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <article className="bg-gray-50 rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Learn how Dr. Janet Duffy helps homeowners sell properties that traditional real
                  estate agents won't touch. From hoarder homes to properties with major damage, we
                  buy houses in any condition throughout Las Vegas and Southern California.
                </p>
                <a
            ...
            <article className="bg-gray-50 rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Discover the hidden costs of selling a house traditionally versus selling to a
                  cash buyer. Dr. Duffy breaks down all the fees and expenses you can avoid when
                  working with Speedy Cash Home Offers.
                </p>
                <a
                  href="/market-insights"
                  className="text-pink-600 font-medium hover:text-pink-700"
            ...
            <article className="bg-gray-50 rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Deployment? Sell Your Las Vegas House for Cash Before Relocating For Military
                  Active Duty. Learn how we help military families sell quickly and stress-free,
                  understanding the unique challenges of military relocations.
                </p>
                <a
                  href="/market-insights"
                  className="text-pink-600 font-medium hover:text-pink-700"
            ...
            <article className="bg-gray-50 rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Why choose Dr. Janet Duffy and Speedy Cash Home Offers? Learn about our proven
                  track record and commitment to fair, fast transactions in Las Vegas and Southern
                  California markets.
                </p>
                <a
                  href="/market-insights"
            ...
            <article className="bg-gray-50 rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Skip the traditional MLS listing process. Learn how to sell your house directly to
                  cash buyers without the hassle of showings, open houses, or waiting for the right
                  buyer in Las Vegas or Southern California.
                </p>
                <a
                  href="/market-insights"
                  className="text-pink-600 font-medium hover:text-pink-700"
            ...
            <article className="bg-gray-50 rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Inheriting a home can be overwhelming. Dr. Duffy shares how we help families
                  navigate the emotional and practical aspects of selling inherited properties,
            ...
            <article className="bg-gray-50 rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Learn from Dr. Duffy's 25+ years of experience. Discover the most common mistakes
                  homeowners make when selling and how to avoid them, ensuring a smooth transaction
                  process.
                </p>
                <a
                  href="/market-insights"
            ...
            <article className="bg-gray-50 rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  What to look for when choosing a cash home buyer. Learn how to identify legitimate
                  companies and avoid scams in the real estate industry, ensuring you work with
            ...
            <article className="bg-gray-50 rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Don't let the condition of your home stop you from selling. We buy houses in any
                  condition, including those that need extensive cleaning or repairs, throughout Las
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                25+ years of real estate experience from Dr. Janet Duffy
              </p>
            </div>
            <div className="text-center">
              <div className="bg-pink-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600">
                Specialized insights for Las Vegas and Southern California markets
              </p>
            </div>
            <div className="text-center">
              <div className="bg-pink-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600">
                Actionable advice for real-world home selling situations
              </p>
            </div>
            <div className="text-center">
              <div className="bg-pink-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">
            Get the latest home selling tips and market insights from Dr. Janet Duffy delivered to
            your inbox. Stay informed about Las Vegas and Southern California real estate trends,
            cash home buying opportunities, and expert advice for selling your property quickly and
            efficiently.
          </p>
      ...
      <section className="py-16 bg-pink-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8">
            Dr. Janet Duffy has purchased thousands of houses and we can buy yours in just a few
            days. We buy houses for cash and there is no obligation, so contact us today! Let our
            blog insights guide you toward making the best decision for your property sale.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-white text-pink-600 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-gray-100 transition-colors">
              Get My Free Quote
