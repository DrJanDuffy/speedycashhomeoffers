...
export const meta: Route.MetaFunction = () => {
  return [
    ...
    { name: "twitter:description", content: "Privacy Policy for Speedy Cash Home Offers. Learn how we protect your personal information." },
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-lg shadow-lg p-8 md:p-12 prose prose-lg max-w-none">
            ...
            <p className="text-gray-700 mb-6">
              Speedy Cash Home Offers ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website, use our services, or contact us about selling your property.
            </p>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4 mt-8">4. Information Sharing and Disclosure</h2>
            <p className="text-gray-700 mb-4">
              We do not sell your personal information. We may share your information only in the following circumstances:
            </p>
            <ul className="list-disc pl-6 mb-6 text-gray-700 space-y-2">
              <li><strong>Service Providers:</strong> We may share information with third-party service providers who perform services on our behalf, such as customer relationship management (CRM) systems, email services, and analytics providers.</li>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4 mt-8">6. Your Rights and Choices</h2>
            <p className="text-gray-700 mb-4">
            ...
            <p className="text-gray-700 mb-6">
              To exercise these rights, please contact us at <a href="mailto:DrDuffy@SpeedyCashHomeOffers.com" className="text-blue-600 hover:text-blue-800">DrDuffy@SpeedyCashHomeOffers.com</a> or call us at <a href="tel:(702) 500-1981" className="text-blue-600 hover:text-blue-800">(702) 500-1981</a>.
            </p>
