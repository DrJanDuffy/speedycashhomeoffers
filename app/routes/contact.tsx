        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
              ...
              There is no obligation, so contact us today and we will share some house selling tips too!
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-4xl mx-auto">
              At Speedy Cash Home Offers, we understand that selling your home can be one of the most important decisions you'll make. 
              Whether you're facing foreclosure, dealing with an inherited property, going through a divorce, relocating for work, 
              or simply want to avoid the traditional selling process, we're here to help. Our experienced team, led by Dr. Janet Duffy, 
              has helped thousands of homeowners across Las Vegas and Southern California sell their properties quickly and stress-free.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose max-w-none">
            <p className="text-lg text-gray-600 mb-6">
              Are you wanting to sell a home and have been searching for a house buying website? Have you been wondering "Can I get cash for my home quick" or "can I sell my house fast Las Vegas"? Do you have your house for sale by owner or are thinking to list your home for sale by owner? Speedy Cash Home Offers can help you and buy your house!
            </p>
            
            <p className="text-lg text-gray-600 mb-6">
              There are many home buying websites and companies that say "we buy houses as is, in any condition" or they can give you a fast house sale. It's important to know that these companies may or may not have successful track records of making the process easy for you and closing in a timely manner. We have purchased thousands of houses and have a system that minimizes the work for the home seller. We will only make a cash offer for your home if we can complete the transaction in a timely manner and simplify it for you!
            </p>
            
            <p className="text-lg text-gray-600 mb-8">
              When considering working with a company to sell your home to, make sure to review their history and their online testimonials. We have an A+ rating with the Better Business Bureau because of our process and our experience. We buy houses in Las Vegas and Southern California so don't take a chance when selling what is likely your largest asset, your home.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-12">
            <div className="bg-gray-50 rounded-lg shadow-lg p-6 text-center">
              ...
              <p className="text-gray-600">We have purchased thousands of houses with a system that minimizes work for home sellers.</p>
            </div>
            <div className="bg-gray-50 rounded-lg shadow-lg p-6 text-center">
              <div className="bg-emerald-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-8 h-8 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-gray-600">We maintain an A+ rating with the Better Business Bureau because of our process and experience.</p>
            </div>
            <div className="bg-gray-50 rounded-lg shadow-lg p-6 text-center">
              <div className="bg-emerald-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-8 h-8 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-gray-600">We only make cash offers if we can complete the transaction quickly and simplify it for you.</p>
            </div>
          </div>
        </div>
      </section>
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <svg className="w-6 h-6 text-emerald-600 mr-4 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                  </svg>
                  <div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-center text-gray-600 mb-12 max-w-4xl mx-auto">
            Speedy Cash Home Offers proudly serves homeowners throughout Las Vegas and Southern California. 
            Our extensive market knowledge allows us to provide accurate valuations and competitive cash offers 
            for properties in various communities and neighborhoods.
          </p>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-gray-50 rounded-lg p-6 text-center">
              <h3 className="text-xl font-semibold text-emerald-600 mb-2">Las Vegas</h3>
              <p className="text-gray-600">Serving all Las Vegas neighborhoods and surrounding areas</p>
            </div>
            <div className="bg-gray-50 rounded-lg p-6 text-center">
      ...
      <section className="py-16 bg-emerald-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8">
            Dr. Janet Duffy has purchased thousands of houses and we can buy yours in just a few days. 
            There is no obligation, so contact us today! Get your free cash offer and discover how 
