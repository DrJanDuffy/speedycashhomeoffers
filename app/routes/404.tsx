      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        <div className="mt-8">
          ...
          <div className="flex flex-wrap justify-center gap-2">
            <Link to="/sell-my-house-fast-las-vegas" className="px-4 py-2 bg-blue-100 text-blue-800 rounded-full text-sm hover:bg-blue-200 transition-colors">
              Sell House Las Vegas
            </Link>
            <Link to="/sell-my-house-fast-southern-california" className="px-4 py-2 bg-blue-100 text-blue-800 rounded-full text-sm hover:bg-blue-200 transition-colors">
              Sell House California
            </Link>
            <Link to="/process" className="px-4 py-2 bg-blue-100 text-blue-800 rounded-full text-sm hover:bg-blue-200 transition-colors">
              Cash Home Buyers
            </Link>
            <Link to="/testimonials" className="px-4 py-2 bg-blue-100 text-blue-800 rounded-full text-sm hover:bg-blue-200 transition-colors">
              Reviews
            </Link>
          </div>
        </div>
